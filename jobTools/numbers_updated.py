def find_missing_and_repeated_entries(runs, runDigits, subruns, subrunDigits, separator, entries):
...
missing_filename = 'missing_entries.txt'
save_entries_to_file(missing, missing_filename)

# Save repeated entries to file
repeated_filename = 'repeated_entries.txt'
save_entries_to_file(repeated, repeated_filename)
